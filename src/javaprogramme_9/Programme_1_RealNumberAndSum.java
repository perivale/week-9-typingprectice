 ...
 */
public class Programme_1_RealNumberAndSum {
  public static void readTenNumberAndSum() {
      //scanner declearation for reading input  form  console
      ...
      while (true) {
          ...
          if (isAnInt) {
              ...
              scanner.nextLine();//handle end of array
          }
          System.out.println("sum =" + sum);
          //consing the scaneer obj
          scanner.close();
      }
  }
